...
<div class="formuel-wrapper">
    ...
    <form class="formuel-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" enctype="multipart/form-data">
        <input type="hidden" name="action" value="formuel_submit" />
