...
final class Formuel_Plugin
{
    ...
    public static function init(): void
    {
        ...
        add_action('admin_post_formuel_submit', [Formuel_Shortcode::class, 'handle_submission']);
        add_action('admin_post_nopriv_formuel_submit', [Formuel_Shortcode::class, 'handle_submission']);
